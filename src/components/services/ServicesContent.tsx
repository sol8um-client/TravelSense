...
export default function ServicesContent() {
  return (
    <>
      {/* ── HERO - light mesh, display headline, glass service chips ─────────── */}
      <section className="relative overflow-hidden bg-brand-mesh px-4 pt-[120px] pb-20 sm:px-6 sm:pt-[150px] sm:pb-24">
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(closest-side, rgba(74,120,205,0.10), transparent 72%)",
              filter: "blur(100px)",
            }}
          />
        </div>
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          >
            Everything,{" "}
            <span className="italic font-normal text-secondary">handled.</span>
          </motion.h1>
          ...
          >
            From the first idea to the last sunset, every part of your journey is taken
            care of by a real human team - planning, stays, transfers, visas and more.
          </motion.p>
