...
export interface Package {
  ...
  category: "leisure" | "adventure" | "educational"
  description: string
  heroImage: string
  images: string[]
  ...
  /**
   * Optional richer "experience storytelling" intro that replaces a dry tour
   * summary with a more evocative, branded narrative (e.g. Leh expedition
   * framing). Rendered above the day-by-day itinerary when present.
   */
...
export const packages: Package[] = [
  ...
  },
  {
    ...
    itinerary: [
      ...
      {
        day: 6,
        title: "Ubud Waterfalls, Rice Terraces & Balinese Spa",
        description:
          "A day in the green heart of Bali. Morning at the Tegenungan and Tibumana waterfalls for a swim under the falls, then the UNESCO-listed Tegallalang Rice Terraces and the Bali Swing for the iconic jungle-valley photo. Afternoon a traditional Balinese massage at an Ubud spa, ending with a walk through Ubud's Monkey Forest and art market.",
        activities: ["Tegenungan Waterfall", "Tibumana Waterfall", "Tegallalang Rice Terraces", "Bali Swing", "Balinese spa massage", "Ubud Monkey Forest"],
        meals: "Breakfast",
        accommodation: "Resort in Seminyak",
  ...
  },
  {
    ...
    itinerary: [
      {
        day: 1,
        title: "Arrive Colombo – Dambulla",
        description:
          "Arrive at Bandaranaike International Airport and drive to Dambulla, stopping at the Pinnawala Elephant Orphanage en route. Check in and relax in the heart of the cultural triangle.",
        activities: ["Pinnawala Elephant Orphanage", "Drive to Dambulla"],
        meals: "Dinner",
        accommodation: "Hotel in Dambulla",
        highlight: "Into the cultural triangle",
      ...
      },
      {
        ...
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Dambulla",
        highlight: "Sigiriya's rock-top palace",
        image: "https://images.unsplash.com/photo-1566296314736-6eaac1ca0cb9?w=1600&h=900&fit=crop",
      },
      {
        day: 3,
        ...
        description:
          "Drive up into the tea hills to Nuwara Eliya, surrounded by plantations and spring-like weather. Stop at a tea factory to see the leaf-to-cup process and taste a fresh Ceylon brew.",
        activities: ["Tea factory tour", "Ceylon tea tasting", "Nuwara Eliya hills"],
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Nuwara Eliya",
        highlight: "Ceylon tea straight from the estate",
        image: "https://images.unsplash.com/photo-1566296314736-6eaac1ca0cb9?w=1600&h=900&fit=crop",
      },
      {
        day: 4,
        ...
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Nuwara Eliya",
        highlight: "Boating on Lake Gregory",
        image: "https://images.unsplash.com/photo-1566296314736-6eaac1ca0cb9?w=1600&h=900&fit=crop",
      },
      {
        day: 5,
        ...
        highlight: "Colombo's seafront and temples",
        image: "https://images.unsplash.com/photo-1566296314736-6eaac1ca0cb9?w=1600&h=900&fit=crop",
      },
      {
        day: 6,
  ...
  },
  {
    ...
    inclusions: [
      ...
      "All sightseeing in a private air-conditioned vehicle",
      "Tufandag (Gabala) and Shahdag mountain cable-car/gondola rides",
      "English-speaking local guide for city tours",
      "All applicable taxes, tolls, parking and driver allowance",
    ],
    exclusions: [
      "International airfare to/from Baku",
      "Azerbaijan e-visa fee",
      "Lunches and any meal not mentioned in the itinerary",
    ...
    itinerary: [
      ...
      },
      {
        ...
        meals: "Breakfast, Dinner",
        accommodation: "Hotel near Quba / Qusar",
        highlight: "Tufandag cableway over the Caucasus",
      ...
      },
      {
        ...
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Baku",
        highlight: "Gobustan's bubbling mud volcanoes",
        image: "https://images.unsplash.com/photo-1565008576549-57569a49371d?w=1600&h=900&fit=crop",
      },
      {
        day: 8,
  ...
  },
  {
    ...
    highlights: [
      "Hampi UNESCO ruins & Stone Chariot",
      "Badami cave temples & Pattadakal",
      "Belur & Halebid Hoysala temples",
      "Shravanabelagola Gomateshwara",
      "Chikmagalur coffee hills & Mullayangiri",
      "Coracle ride on the Tungabhadra",
    ],
    itinerary: [
      {
        day: 1,
        title: "Bengaluru – Shravanabelagola – Hassan",
        description:
          "Arrive at Bengaluru and drive to Hassan, stopping en route at Shravanabelagola to see the 17-metre monolithic statue of Lord Bahubali (Gomateshwara). Evening at leisure in Hassan.",
        activities: ["Bengaluru arrival", "Shravanabelagola", "Gomateshwara statue", "Drive to Hassan"],
        meals: "Dinner",
        accommodation: "Hotel in Hassan",
        highlight: "Gomateshwara monolith",
        image: "/images/generated/karnataka-hero.webp",
      },
      {
        day: 2,
        title: "Hassan – Belur – Halebid – Hampi",
        description:
          "Visit Belur's Chennakeshava Temple on the banks of the Yagachi, then the 12th-century Hoysaleswara Temple at Halebid with its intricate stone friezes. Continue to Hampi, the former Vijayanagara capital, for the night.",
        activities: ["Belur Chennakeshava Temple", "Halebid Hoysaleswara Temple", "Drive to Hampi"],
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Hampi",
        highlight: "Hoysala temple carvings",
        image: "/images/generated/karnataka-hero.webp",
      },
      {
        day: 3,
        ...
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Hampi",
        highlight: "The Vittala Stone Chariot",
        image: "/images/generated/karnataka-hero.webp",
      },
      {
        day: 4,
        ...
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Hampi",
        highlight: "Badami cliff-carved caves",
        image: "/images/generated/karnataka-hero.webp",
      },
      {
        day: 5,
        ...
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Hampi",
        highlight: "Sunset from Hemakuta Hill",
        image: "/images/generated/karnataka-hero.webp",
      },
      {
        day: 6,
        title: "Hampi – Chitradurga – Chikmagalur",
        description:
          "Drive to Chikmagalur, the 'coffee land of Karnataka', stopping at the dramatic hill fortress of Chitradurga with its seven concentric walls and clever water tanks. Evening arrival in the coffee hills.",
        activities: ["Chitradurga Fort", "Seven-walled fortress", "Drive to Chikmagalur"],
        meals: "Breakfast, Dinner",
        accommodation: "Resort in Chikmagalur",
        highlight: "Chitradurga's seven walls",
        image: "/images/generated/karnataka-hero.webp",
      },
      {
        day: 7,
      ...
      {
        day: 8,
        title: "Chikmagalur – Bengaluru – Departure",
        description:
  ...
  },
  {
    ...
    highlights: [
      "Dudhsagar four-tier waterfall",
      "Bhagwan Mahaveer Sanctuary trek",
      "Castle Rock railway trail",
    ...
    itinerary: [
      {
        day: 1,
        title: "Pune – Overnight Train to Goa",
        description:
          "Meet the team at Pune Railway Station and board the night train (Goa Express) towards the Western Ghats. Settle in for an overnight journey towards Dudhsagar.",
        activities: ["Pune Railway Station meet", "Goa Express boarding", "Overnight train journey"],
        meals: "None",
        accommodation: "Overnight train",
        highlight: "The classic overnight train start",
        image: "https://images.unsplash.com/photo-1591017403286-fd8493524e1e?w=1600&h=900&fit=crop",
      },
      {
        day: 2,
        title: "Kulem – Dudhsagar Falls Trek",
        description:
          "Reach Kulem at dawn for breakfast at the base village, then trek through the Bhagwan Mahaveer Sanctuary to the foot of the Dudhsagar Falls. Explore the four-tiered cascade, lunch back at base, and begin the return journey.",
        activities: ["Kulem base village", "Sanctuary trek", "Dudhsagar Falls", "Four-tier cascade"],
        meals: "Breakfast, Lunch",
        accommodation: "Overnight train",
        highlight: "Standing below the Sea of Milk",
        image: "https://images.unsplash.com/photo-1591017403286-fd8493524e1e?w=1600&h=900&fit=crop",
      },
      {
        day: 3,
  ...
  },
  {
    ...
    highlights: [
      ...
      "Pinnawala Elephant Orphanage",
      "Ella Nine Arch Bridge & tea country",
    ...
    itinerary: [
      {
        ...
        description:
          "Meet our representative at Bandaranaike International Airport and transfer to Colombo, Sri Lanka's vibrant seafront capital. An orientation drive past the Galle Face Green, the old Dutch Hospital and Gangaramaya Temple, then check in for the night.",
        activities: ["Airport pickup", "Galle Face Green", "Gangaramaya Temple", "Colombo orientation"],
        meals: "Dinner",
        accommodation: "Hotel in Colombo",
        highlight: "Colombo's seafront promenade",
        image: "https://images.unsplash.com/photo-1566296314736-6eaac1ca0cb9?w=1600&h=900&fit=crop",
      },
      {
        day: 2,
        title: "Colombo – Kandy (Pinnawala en route)",
        description:
          "Drive to the hill city of Kandy, stopping at the Pinnawala Elephant Orphanage to watch the herd bathe in the river. In Kandy, visit the Temple of the Sacred Tooth Relic and enjoy a Kandyan cultural dance show in the evening.",
        activities: ["Pinnawala Elephant Orphanage", "Temple of the Sacred Tooth", "Kandy Lake", "Kandyan dance show"],
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Kandy",
        highlight: "Temple of the Sacred Tooth",
        image: "https://images.unsplash.com/photo-1566296314736-6eaac1ca0cb9?w=1600&h=900&fit=crop",
      },
      {
        day: 3,
        title: "Kandy – Sigiriya Excursion – Kandy",
        description:
          "A day excursion to the Sigiriya Lion Rock, the 5th-century fortress-palace on a 200-metre granite monolith with its frescoes and water gardens, and the nearby Dambulla Cave Temple. Return to Kandy via a spice garden.",
        activities: ["Sigiriya Lion Rock", "Sigiriya frescoes", "Dambulla Cave Temple", "Spice garden"],
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Kandy",
        highlight: "Climbing Sigiriya Lion Rock",
        image: "https://images.unsplash.com/photo-1566296314736-6eaac1ca0cb9?w=1600&h=900&fit=crop",
      },
      {
        day: 4,
        title: "Kandy – Ella",
        description:
          "Take the scenic route to Ella, a laid-back hill town wrapped in tea estates. See the famous Nine Arch Bridge, Little Adam's Peak and the Ravana Falls, with sweeping views over the misty valley.",
        activities: ["Nine Arch Bridge", "Little Adam's Peak", "Ravana Falls", "Ella tea estates"],
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Ella",
        highlight: "The Nine Arch Bridge",
        image: "https://images.unsplash.com/photo-1566296314736-6eaac1ca0cb9?w=1600&h=900&fit=crop",
      },
      {
        day: 5,
        title: "Ella – Galle",
        description:
          "Descend to the south coast and the historic port of Galle. Walk the ramparts of the UNESCO-listed Galle Dutch Fort, its lighthouse, churches and boutique lanes, then unwind by the sea.",
        activities: ["Galle Dutch Fort", "Fort ramparts walk", "Galle Lighthouse", "South-coast beach"],
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Galle",
        highlight: "Sunset on the Galle Fort ramparts",
        image: "https://images.unsplash.com/photo-1566296314736-6eaac1ca0cb9?w=1600&h=900&fit=crop",
      },
      {
        day: 6,
        ...
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Colombo",
        highlight: "Colombo city highlights",
        image: "https://images.unsplash.com/photo-1566296314736-6eaac1ca0cb9?w=1600&h=900&fit=crop",
      },
      {
        day: 7,
    ...
    itinerary: [
      {
        ...
        description:
          "Arrive and drive to Kandy, the island's hill capital, stopping at the Pinnawala Elephant Orphanage en route. Evening visit to the Temple of the Sacred Tooth Relic and a Kandyan cultural show.",
        activities: ["Pinnawala Elephant Orphanage", "Temple of the Sacred Tooth", "Kandyan dance show"],
        meals: "Dinner",
        accommodation: "Hotel in Kandy",
        highlight: "Temple of the Sacred Tooth",
        image: "https://images.unsplash.com/photo-1566296314736-6eaac1ca0cb9?w=1600&h=900&fit=crop",
      },
      {
        ...
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Kandy",
        highlight: "The summit of Sigiriya",
        image: "https://images.unsplash.com/photo-1566296314736-6eaac1ca0cb9?w=1600&h=900&fit=crop",
      },
      {
        day: 3,
        ...
        description:
          "Drive into the hills to Nuwara Eliya, 'Little England', past the towering Bahiravokanda Vihara Buddha statue and a working tea factory. Explore the colonial town, tea estates and cool spring-like weather.",
        activities: ["Bahiravokanda Buddha", "Tea factory tour", "Nuwara Eliya town", "Tea estates"],
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Nuwara Eliya",
        highlight: "Tea-carpeted hills of Nuwara Eliya",
        image: "https://images.unsplash.com/photo-1566296314736-6eaac1ca0cb9?w=1600&h=900&fit=crop",
      },
      {
        day: 4,
        ...
        description:
          "Descend to the west-coast beach town of Bentota, stopping at the Royal Botanical Garden at Peradeniya en route. Evening on the beach with optional water sports on the Bentota river.",
        activities: ["Royal Botanical Garden", "Bentota beach", "Bentota river water sports"],
        meals: "Breakfast, Dinner",
        accommodation: "Resort in Bentota",
        highlight: "First sunset on Bentota beach",
        image: "https://images.unsplash.com/photo-1566296314736-6eaac1ca0cb9?w=1600&h=900&fit=crop",
      },
      {
        day: 5,
        ...
        meals: "Breakfast, Dinner",
        accommodation: "Resort in Bentota",
        highlight: "Spotting blue whales off Mirissa",
        image: "https://images.unsplash.com/photo-1566296314736-6eaac1ca0cb9?w=1600&h=900&fit=crop",
      },
      {
        day: 6,
        ...
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Colombo",
        highlight: "Colombo's mix of old and new",
        image: "https://images.unsplash.com/photo-1566296314736-6eaac1ca0cb9?w=1600&h=900&fit=crop",
      },
      {
        day: 7,
    ...
    itinerary: [
      {
        ...
        title: "Indore – Ujjain",
        description:
          "Arrive at Indore and drive to Ujjain, the ancient city on the banks of the Kshipra. Visit the Mahakaleshwar Jyotirlinga, one of the twelve sacred shrines of Shiva, the Kal Bhairav temple and the Ram Ghat for the evening aarti.",
        activities: ["Mahakaleshwar Jyotirlinga", "Kal Bhairav temple", "Ram Ghat aarti", "Kshipra river"],
        meals: "Dinner",
        accommodation: "Hotel in Ujjain",
        highlight: "Evening aarti at Mahakaleshwar",
      ...
      },
      {
        ...
        description:
          "Drive south to Omkareshwar, where a Narmada-island shaped like the sacred 'OM' holds another of the twelve Jyotirlingas. Take the boat across, visit the Omkareshwar and Mamleshwar temples, and stay overnight by the river.",
        activities: ["Omkareshwar Jyotirlinga", "Narmada island boat", "Mamleshwar temple", "River ghats"],
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Omkareshwar",
        highlight: "The OM-shaped island shrine",
        image: "https://images.unsplash.com/photo-1609920658906-8223bd289001?w=1600&h=900&fit=crop",
      },
      {
        day: 3,
        title: "Omkareshwar – Maheshwar",
        description:
          "Drive to Maheshwar, the riverside town rebuilt by the queen Ahilyabai Holkar. Tour the Ahilya Fort and the cluster of riverside temples, shop for the famous Maheshwari saris, and take an evening boat on the Narmada.",
        activities: ["Ahilya Fort", "Riverside temples", "Maheshwari sari weavers", "Narmada boating"],
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Maheshwar",
        highlight: "Sunset boat on the Narmada",
        image: "https://images.unsplash.com/photo-1609920658906-8223bd289001?w=1600&h=900&fit=crop",
      },
      {
        day: 4,
        ...
        description:
          "Travel to the hilltop fortress city of Mandu. Explore the Rani Roopmati Pavilion, the Jami Masjid, the ship-shaped Jahaz Mahal and Baz Bahadur's Palace, set among monsoon-green ravines.",
        activities: ["Rani Roopmati Pavilion", "Jami Masjid", "Jahaz Mahal", "Baz Bahadur's Palace"],
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Mandu",
        highlight: "Jahaz Mahal, the ship palace",
        image: "https://images.unsplash.com/photo-1609920658906-8223bd289001?w=1600&h=900&fit=crop",
      },
      {
        day: 5,
  ...
  },
  {
    ...
    itinerary: [
      ...
      },
      {
        ...
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Manali",
        highlight: "Naggar Castle & Jana Falls",
  ...
  },
  {
    ...
    itinerary: [
      ...
      },
      {
        ...
        highlight: "Baijnath Temple & Andretta pottery",
        image: "/images/generated/manali-valley.webp",
      },
      {
        day: 8,
  ...
  },
  {
    ...
    itinerary: [
      ...
      },
      {
        ...
        accommodation: "Hotel in Dharamshala",
        distance: "125 km drive",
        highlight: "Norbulingka Institute gardens",
        image: "/images/generated/mcleodganj-monastery.webp",
      },
      {
        day: 5,
  ...
  },
  {
    ...
    itinerary: [
      ...
      },
      {
        ...
        distance: "85 km loop",
        highlight: "Crossing the Chicham Bridge",
        image: "/images/generated/spiti-kaza-village.webp",
      },
      {
        day: 7,
  ...
  },
  {
    ...
    itinerary: [
      ...
      {
        day: 2,
        title: "Agra Fort, then Mathura & Vrindavan",
        description:
        ...
        activities: ["Drive to Mathura", "Krishna Janmabhoomi", "Dwarkadhish Temple", "Banke Bihari aarti", "ISKCON Vrindavan", "Agra Fort", "Vishram Ghat Yamuna Aarti"],
        meals: "Breakfast, Dinner",
  ...
  },
  {
    ...
    itinerary: [
      ...
      },
      {
        ...
        highlight: "Ranakpur's 1,444 marble pillars",
        image: "/images/generated/rajasthan-day-7-udaipur-lake-palace.webp",
      },
      {
        day: 8,
        ...
        accommodation: "Hotel in Udaipur",
        distance: "85 km drive",
        highlight: "The Great Wall of India at Kumbhalgarh",
        image: "/images/generated/rajasthan-day-7-udaipur-lake-palace.webp",
      },
      {
        day: 9,
  ...
  },
  {
    ...
    itinerary: [
      ...
      {
        day: 6,
        title: "Drive Nainital to Ranikhet via Mukteshwar & Kasar Devi",
        description:
        ...
        activities: ["Drive to Ranikhet", "Chaubatia Gardens", "Jhula Devi Temple", "Sunset at Upat", "Mukteshwar", "Kasar Devi"],
        meals: "Breakfast, Dinner",
  ...
  },
  {
    ...
    itinerary: [
      ...
      },
      {
        ...
        meals: "Breakfast",
        accommodation: "4-star resort on Long Beach",
        highlight: "White tigers at Vinpearl Safari",
        image: "https://images.unsplash.com/photo-1559592413-7cec4d0cae2b?w=1600&h=900&fit=crop",
      },
      {
        day: 5,
    ...
    itinerary: [
      {
        ...
        activities: ["Airport pickup", "Evening at leisure"],
        meals: "Breakfast",
        accommodation: "Hotel in Bangkok",
  ...
  /* ═══════════════════════ DUBAI — DOCX 5 ═══════════════════════ */
  {
    ...
    highlights: [
      "Burj Khalifa At The Top (124-125th floor)",
    ...
    itinerary: [
      {
        ...
        highlight: "Ain Dubai over the marina at sunset",
      ...
      },
      {
        ...
        meals: "Breakfast",
        accommodation: "Hotel in Dubai",
        highlight: "Museum of the Future + Burj Khalifa sunset",
      ...
      },
      {
        ...
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Dubai",
        highlight: "Desert dune bashing + camp dinner",
      ...
      },
      {
        ...
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Dubai",
        highlight: "The View at The Palm + Marina dhow cruise",
      ...
      {
        day: 6,
        title: "La Mer Beach, Dubai Aquarium Zoo & Ain Dubai Ride",
        description: "Morning at the colourful La Mer Beach and the Jameel Arts area, then the Dubai Mall district and Bluewaters Island. Afternoon a ride on Ain Dubai (the world's largest observation wheel, 250 m) for panoramic city-and-coast views, finishing at the Dubai Festival City for the IMAGINE laser-and-fountain show in the evening.",
  ...
  },
  {
    ...
    itinerary: [
      ...
      {
        day: 8,
        title: "Genting Highlands & KL Shopping",
        description: "Awana SkyWay cable car up to Genting Highlands for the hilltop theme park and SkyAvenue, with the Chin Swee Caves Temple en route. Evening shopping at Pavilion KL and Bukit Bintang.",
        activities: ["Awana SkyWay cable car", "Genting SkyAvenue", "Chin Swee Caves Temple", "Pavilion KL shopping"],
        meals: "Breakfast",
        accommodation: "Hotel in Kuala Lumpur",
  ...
  },
  {
    ...
    reviewCount: 64,
    inclusions: [
      "9 nights in 4-star hotels and a safari lodge",
      "Daily breakfast + safari full-board",
      "Table Mountain & Cape Point tours",
      "Cape Winelands tasting tour",
      "Garden Route scenic drive",
      "2-night Greater Kruger safari with game drives",
      "All inter-city transfers + 1 domestic flight",
    ],
    exclusions: [
    ...
    itinerary: [
      {
        ...
        description:
          "Arrive in Cape Town and transfer to your hotel. Evening at the V&A Waterfront with views of Table Mountain.",
        activities: ["Airport pickup", "V&A Waterfront"],
        meals: "Dinner",
        accommodation: "Hotel in Cape Town",
        highlight: "Table Mountain over the harbour",
      ...
      },
      {
        ...
        description:
          "Cable car up Table Mountain, then a city tour of the Company's Garden, Bo-Kaap and Signal Hill.",
        activities: ["Table Mountain cable car", "Bo-Kaap quarter", "Signal Hill"],
        meals: "Breakfast",
        accommodation: "Hotel in Cape Town",
        highlight: "Flat-top summit views",
        image: "https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?w=1600&h=900&fit=crop",
      },
      {
        day: 3,
        ...
        meals: "Breakfast",
        accommodation: "Hotel in Cape Town",
        highlight: "Penguins at Boulders Beach",
      ...
      },
      {
        ...
        description:
          "Day trip to Stellenbosch and Franschhoek for cellar tours and wine tasting among the Cape Dutch estates.",
        activities: ["Stellenbosch", "Franschhoek", "Wine tasting"],
        meals: "Breakfast",
        accommodation: "Hotel in Cape Town",
        highlight: "Cape Dutch wine estates",
        image: "https://images.unsplash.com/photo-1521651201144-634f700b36ef?w=1600&h=900&fit=crop",
      },
      {
        day: 5,
        ...
        highlight: "Knysna Heads lagoon",
        image: "https://images.unsplash.com/photo-1534177616072-ef7dc120449d?w=1600&h=900&fit=crop",
      },
      {
        day: 6,
        title: "Knysna & Tsitsikamma",
        description:
          "Explore the Knysna Heads and the forests and suspension bridge of Tsitsikamma National Park.",
        activities: ["Knysna Heads", "Tsitsikamma National Park", "Storms River bridge"],
        meals: "Breakfast",
        accommodation: "Hotel in Knysna",
        highlight: "Tsitsikamma forest gorge",
        image: "https://images.unsplash.com/photo-1484318571209-661cf29a69c3?w=1600&h=900&fit=crop",
      },
      {
        day: 7,
        title: "Fly to the Greater Kruger",
        description:
          "Drive to George/Port Elizabeth and fly via Johannesburg to the Greater Kruger. Evening game drive on arrival at the lodge.",
        activities: ["Domestic flight", "Safari lodge check-in", "Evening game drive"],
        meals: "Breakfast, Dinner",
        accommodation: "Safari lodge, Greater Kruger",
        highlight: "First sundowner game drive",
      ...
      },
      {
        ...
        meals: "Breakfast, Lunch, Dinner",
        accommodation: "Safari lodge, Greater Kruger",
        highlight: "Big Five at close range",
        image: "https://images.unsplash.com/photo-1535941339077-2dd1c7963098?w=1600&h=900&fit=crop",
      },
      {
        day: 9,
        title: "Kruger to Johannesburg",
        description:
          "Morning game drive, then drive/fly to Johannesburg for a city and Soweto tour including the Apartheid Museum.",
        activities: ["Morning game drive", "Soweto tour", "Apartheid Museum"],
        meals: "Breakfast",
        accommodation: "Hotel in Johannesburg",
        highlight: "Soweto & Apartheid Museum",
        image: "https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?w=1600&h=900&fit=crop",
      },
      {
        day: 10,
  ...
  },
  {
    ...
    reviewCount: 52,
    inclusions: [
      "6 nights in safari lodges and tented camps",
      "Full board on safari (all meals)",
      "Game drives in 4x4 with pop-up roof",
      "Park and conservancy entry fees",
      "Services of a professional safari guide",
      "All ground transfers; Maasai village visit",
    ],
    exclusions: [
      "International airfare unless specified",
      "Visa fees and travel insurance",
    ...
    itinerary: [
      {
        ...
        description:
          "Arrive in Nairobi and transfer to your hotel. Optional visit to the Giraffe Centre or the Sheldrick elephant orphanage.",
        activities: ["Airport pickup", "Giraffe Centre (optional)"],
        meals: "Dinner",
        accommodation: "Hotel in Nairobi",
        highlight: "Gateway to the safari",
        image: "https://images.unsplash.com/photo-1516426122078-c23e76319801?w=1600&h=900&fit=crop",
      },
      {
        day: 2,
        title: "Nairobi to Masai Mara",
        description:
          "Drive through the Great Rift Valley to the Masai Mara. Afternoon game drive on arrival.",
        activities: ["Rift Valley viewpoint", "Masai Mara afternoon game drive"],
        meals: "Breakfast, Lunch, Dinner",
        accommodation: "Tented camp, Masai Mara",
        highlight: "First big-cat sighting",
        image: "https://images.unsplash.com/photo-1547970810-dc1eac37d174?w=1600&h=900&fit=crop",
      },
      {
        day: 3,
        ...
        meals: "Breakfast, Lunch, Dinner",
        accommodation: "Tented camp, Masai Mara",
        highlight: "Lions on the open savannah",
        image: "https://images.unsplash.com/photo-1535941339077-2dd1c7963098?w=1600&h=900&fit=crop",
      },
      {
        day: 4,
        ...
        description:
          "Drive to Lake Nakuru National Park, famous for its flamingos and as a rhino sanctuary. Afternoon game drive.",
        activities: ["Lake Nakuru game drive", "Flamingo flocks", "Rhino sanctuary"],
        meals: "Breakfast, Lunch, Dinner",
        accommodation: "Lodge near Lake Nakuru",
        highlight: "Pink flamingos & rhino",
        image: "https://images.unsplash.com/photo-1549366021-9f761d450615?w=1600&h=900&fit=crop",
      },
      {
        day: 5,
        title: "Nakuru to Amboseli",
        description:
          "Long drive south to Amboseli National Park, framed by Mount Kilimanjaro. Evening game drive among the elephant herds.",
        activities: ["Drive to Amboseli", "Evening game drive", "Elephant herds"],
        meals: "Breakfast, Lunch, Dinner",
        accommodation: "Lodge in Amboseli",
        highlight: "Elephants under Kilimanjaro",
        image: "https://images.unsplash.com/photo-1534177616072-ef7dc120449d?w=1600&h=900&fit=crop",
      },
      {
        day: 6,
        ...
        meals: "Breakfast, Lunch, Dinner",
        accommodation: "Lodge in Amboseli",
        highlight: "Kilimanjaro at sunrise",
        image: "https://images.unsplash.com/photo-1516426122078-c23e76319801?w=1600&h=900&fit=crop",
      },
      {
        day: 7,
  ...
  },
  {
    ...
    reviewCount: 44,
    inclusions: [
      "5 nights in hotels + a Wadi Rum desert camp",
      "Daily breakfast + camp dinners",
      "Jordan Pass (visa + Petra + 40 sites)",
      "Petra guided tour through the Siq",
      "Wadi Rum 4x4 jeep safari",
      "Dead Sea resort access; all transfers",
    ],
    exclusions: [
      "International airfare unless specified",
      "Visa fees and travel insurance",
    ...
    itinerary: [
      {
        ...
        highlight: "Colonnaded streets of Jerash",
        image: "https://images.unsplash.com/photo-1539020140153-e479b8c22e70?w=1600&h=900&fit=crop",
      },
      {
        day: 2,
        title: "Amman to Petra via Mount Nebo & Madaba",
        description:
          "Drive the King's Highway to Petra, stopping at the mosaics of Madaba and the Moses viewpoint of Mount Nebo.",
        activities: ["Madaba mosaics", "Mount Nebo", "Drive to Petra"],
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Petra",
        highlight: "First view of Wadi Musa",
        image: "https://images.unsplash.com/photo-1547234935-80c7145ec969?w=1600&h=900&fit=crop",
      },
      {
        day: 3,
      ...
      },
      {
        ...
        description:
          "Drive to Wadi Rum for a 4x4 jeep safari among the red dunes and rock arches, with a night at a Bedouin desert camp.",
        activities: ["Wadi Rum jeep safari", "Rock arches", "Bedouin camp dinner", "Stargazing"],
        meals: "Breakfast, Dinner",
      ...
      },
      {
        ...
        description:
          "Drive north to the Dead Sea, the lowest point on Earth, for an afternoon float and a mineral-mud spa.",
        activities: ["Drive to Dead Sea", "Float in the Dead Sea", "Mineral mud spa"],
        meals: "Breakfast",
        accommodation: "Dead Sea resort",
        highlight: "Floating in the Dead Sea",
        image: "https://images.unsplash.com/photo-1580834341580-8c17a3a630ca?w=1600&h=900&fit=crop",
      },
      {
        day: 6,
  ...
  },
  {
    ...
    slug: "iceland-northern-lights-7d",
    ...
    reviewCount: 38,
    inclusions: [
      "6 nights in 3-4 star hotels with daily breakfast",
      "Golden Circle & south coast tours",
      "Jokulsarlon glacier lagoon visit",
      "Blue Lagoon entry (with transfer)",
      "Northern Lights hunt (winter departures)",
      "All transfers and an English-speaking guide",
    ],
    exclusions: [
      "International airfare unless specified",
      "Visa fees and travel insurance",
    ...
    highlights: [
      ...
      "Golden Circle geysers & Gullfoss",
    ...
    itinerary: [
      {
        day: 1,
        title: "Arrive Reykjavik",
        description:
          "Arrive at Keflavik and transfer to Reykjavik. Evening walk to the Hallgrimskirkja church and Harpa concert hall.",
        activities: ["Airport pickup", "Hallgrimskirkja", "Harpa harbour"],
        meals: "Dinner",
        accommodation: "Hotel in Reykjavik",
        highlight: "Colourful Reykjavik",
      ...
      },
      {
        ...
        title: "Golden Circle",
        description:
          "The Thingvellir tectonic rift, the erupting Strokkur geyser and the thundering Gullfoss waterfall. Evening Northern Lights hunt.",
        activities: ["Thingvellir rift", "Strokkur geyser", "Gullfoss waterfall", "Aurora hunt"],
        meals: "Breakfast",
        accommodation: "Hotel in Reykjavik",
      ...
      },
      {
        ...
        meals: "Breakfast",
        accommodation: "Hotel near Vik",
        highlight: "Basalt columns of Reynisfjara",
        image: "https://images.unsplash.com/photo-1476610182048-b716b8518aae?w=1600&h=900&fit=crop",
      },
      {
        day: 4,
        title: "Jokulsarlon Glacier Lagoon",
        description:
          "Drive east to the Jokulsarlon glacier lagoon for a boat among the icebergs and the Diamond Beach. Evening aurora hunt.",
        activities: ["Jokulsarlon lagoon", "Diamond Beach", "Glacier views", "Aurora hunt"],
        meals: "Breakfast",
        accommodation: "Hotel near Vik",
        highlight: "Icebergs at Jokulsarlon",
        image: "https://images.unsplash.com/photo-1490650034439-fd184c3c86a5?w=1600&h=900&fit=crop",
      },
      {
        day: 5,
        title: "Return to Reykjavik via Hveragerdi",
        description:
          "Drive back west, stopping at the geothermal village of Hveragerdi and the Kerid crater lake.",
        activities: ["Hveragerdi geothermal area", "Kerid crater", "Reykjavik return"],
        meals: "Breakfast",
        accommodation: "Hotel in Reykjavik",
        highlight: "Steaming earth at Hveragerdi",
        image: "https://images.unsplash.com/photo-1520769669658-f07657f5a307?w=1600&h=900&fit=crop",
      },
      {
        day: 6,
        title: "Blue Lagoon & Reykjavik",
        description:
          "Morning soak at the Blue Lagoon geothermal spa, afternoon to explore Reykjavik's old town and museums.",
        activities: ["Blue Lagoon spa", "Reykjavik old town", "Perlan museum"],
        meals: "Breakfast",
        accommodation: "Hotel in Reykjavik",
        highlight: "Milky-blue Blue Lagoon",
  ...
  },
  {
    ...
    reviewCount: 29,
    inclusions: [
      "6 nights incl. 1 glass-igloo / aurora cabin night",
      "Daily breakfast + select dinners",
      "Husky sled & reindeer sleigh safaris",
      "Santa Claus Village visit",
      "Snowmobile safari with aurora hunt",
      "Helsinki city tour; Rovaniemi-Helsinki flight; thermal gear loan",
    ],
    exclusions: [
      "International airfare unless specified",
      "Visa fees and travel insurance",
    ...
    itinerary: [
      {
        day: 1,
        title: "Arrive Helsinki",
        description:
          "Arrive in Helsinki and transfer to your hotel. Evening at the Senate Square and the seafront market.",
        activities: ["Airport pickup", "Senate Square", "Market Square"],
        meals: "Dinner",
        accommodation: "Hotel in Helsinki",
        highlight: "Helsinki's white cathedral",
        image: "https://images.unsplash.com/photo-1551524559-8af4e6624178?w=1600&h=900&fit=crop",
      },
      {
        day: 2,
        title: "Helsinki to Rovaniemi",
        description:
          "Morning Helsinki tour and the island fortress of Suomenlinna, then fly north to Rovaniemi in Lapland.",
        activities: ["Suomenlinna fortress", "Flight to Rovaniemi", "Arctic arrival"],
        meals: "Breakfast",
        accommodation: "Hotel in Rovaniemi",
        highlight: "Crossing into the Arctic",
      ...
      },
      {
        ...
        description:
          "Cross the Arctic Circle at Santa Claus Village, meet Santa, then a husky-sled safari through the snowy taiga.",
        activities: ["Santa Claus Village", "Arctic Circle line", "Husky sled safari"],
        meals: "Breakfast, Lunch",
        accommodation: "Hotel in Rovaniemi",
        highlight: "Mushing your own husky team",
        image: "https://images.unsplash.com/photo-1518562180175-34a163b1a9a6?w=1600&h=900&fit=crop",
      },
      {
        day: 4,
        title: "Reindeer Sleigh & Glass-Igloo Aurora Night",
        description:
          "A reindeer-sleigh ride and Sami culture by day; tonight, an aurora-cabin / glass-igloo stay to watch the Northern Lights.",
        activities: ["Reindeer sleigh ride", "Sami culture", "Glass-igloo aurora night"],
        meals: "Breakfast, Dinner",
        accommodation: "Glass igloo / aurora cabin",
        highlight: "Aurora from your bed",
        image: "https://images.unsplash.com/photo-1517783999520-f068d7431a60?w=1600&h=900&fit=crop",
      },
      {
        day: 5,
        title: "Snowmobile Safari & Ice Activities",
        description:
          "A snowmobile safari across frozen lakes, ice-fishing and an optional ice-floating experience, with another aurora hunt at night.",
        activities: ["Snowmobile safari", "Ice fishing", "Aurora hunt"],
        meals: "Breakfast, Lunch",
        accommodation: "Hotel in Rovaniemi",
        highlight: "Snowmobiling the frozen wild",
        image: "https://images.unsplash.com/photo-1491466424936-e304919aada7?w=1600&h=900&fit=crop",
      },
      {
        day: 6,
        title: "Rovaniemi to Helsinki",
        description:
          "Morning at leisure for last Arctic activities, then fly back to Helsinki for a final design-district evening.",
        activities: ["Flight to Helsinki", "Design District"],
        meals: "Breakfast",
        accommodation: "Hotel in Helsinki",
        highlight: "Finnish design finale",
        image: "https://images.unsplash.com/photo-1542401886-65d6c61db217?w=1600&h=900&fit=crop",
      },
      {
        day: 7,
        title: "Departure",
  ...
  },
  {
    ...
    reviewCount: 57,
    inclusions: [
      "10 nights in 3-4 star central hotels with breakfast",
      "Eurostar / fast trains and scenic coaches",
      "London & Paris city tours",
      "Swiss Alps cogwheel-train excursion",
      "Venice, Florence & Rome guided sightseeing",
      "All inter-city transfers and a tour manager",
    ],
    exclusions: [
      "International airfare unless specified",
      "Visa fees and travel insurance",
    ...
    highlights: [
      ...
      "Swiss Alps glacier-summit train",
    ...
    itinerary: [
      {
        ...
        title: "Arrive London",
        description:
          "Arrive in London and transfer to your hotel. Evening walk along the South Bank and Westminster.",
        activities: ["Airport pickup", "South Bank", "Westminster"],
        meals: "Dinner",
        accommodation: "Hotel in London",
        highlight: "Big Ben & the Thames",
      ...
      },
      {
        ...
        description:
          "Tower of London, Tower Bridge, Buckingham Palace and a London Eye ride.",
        activities: ["Tower of London", "Buckingham Palace", "London Eye"],
        meals: "Breakfast",
        accommodation: "Hotel in London",
        highlight: "Changing of the Guard",
      ...
      },
      {
        ...
        description:
          "Take the Eurostar under the Channel to Paris. Afternoon Seine cruise and Montmartre.",
        activities: ["Eurostar to Paris", "Seine cruise", "Montmartre"],
        meals: "Breakfast",
        accommodation: "Hotel in Paris",
        highlight: "Under the Channel to Paris",
      ...
      },
      {
        ...
        description:
          "Eiffel Tower summit, the Louvre, Champs-Elysees and the Arc de Triomphe.",
        activities: ["Eiffel Tower", "Louvre Museum", "Champs-Elysees"],
        meals: "Breakfast",
        accommodation: "Hotel in Paris",
        highlight: "Top of the Eiffel Tower",
        image: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=1600&h=900&fit=crop",
      },
      {
        day: 5,
        ...
        description:
          "Scenic train/coach to the Swiss Alps. Evening by Lake Lucerne or Interlaken.",
        activities: ["Train to Switzerland", "Lake Lucerne", "Alpine evening"],
        meals: "Breakfast",
        accommodation: "Hotel in Lucerne / Interlaken",
        highlight: "First Alpine lake view",
        image: "https://images.unsplash.com/photo-1530122037265-a5f1f91d3b99?w=1600&h=900&fit=crop",
      },
      {
        day: 6,
      ...
      },
      {
        ...
        description:
          "Travel south into Italy to Venice. Evening St Mark's Square and a first taste of the canals.",
        activities: ["Travel to Venice", "St Mark's Square", "Canal evening"],
        meals: "Breakfast",
        accommodation: "Hotel in Venice / Mestre",
        highlight: "Venice by lamplight",
        image: "https://images.unsplash.com/photo-1514890547357-a9ee288728e0?w=1600&h=900&fit=crop",
      },
      {
        day: 8,
        title: "Venice & on to Florence",
        description:
          "Gondola ride and Murano glass, then train to Florence, the cradle of the Renaissance.",
        activities: ["Gondola ride", "Murano glass", "Train to Florence"],
        meals: "Breakfast",
        accommodation: "Hotel in Florence",
        highlight: "Gliding the Venetian canals",
        image: "https://images.unsplash.com/photo-1515542622106-78bda8ba0e5b?w=1600&h=900&fit=crop",
      },
      {
        day: 9,
        title: "Florence to Rome",
        description:
          "Florence's Duomo and Ponte Vecchio, then on to Rome. Evening at the Trevi Fountain.",
        activities: ["Florence Duomo", "Ponte Vecchio", "Trevi Fountain"],
        meals: "Breakfast",
        accommodation: "Hotel in Rome",
        highlight: "Tossing a coin at the Trevi",
        image: "https://images.unsplash.com/photo-1515542622106-78bda8ba0e5b?w=1600&h=900&fit=crop",
      },
      {
        day: 10,
        ...
        meals: "Breakfast",
        accommodation: "Hotel in Rome",
        highlight: "Inside the Colosseum",
        image: "https://images.unsplash.com/photo-1552832230-c0197dd311b5?w=1600&h=900&fit=crop",
      },
      {
        day: 11,
        title: "Departure",
  ...
  },
  {
    ...
    reviewCount: 41,
    inclusions: [
      "7 nights in 3-4 star central hotels with breakfast",
      "Fast trains/coaches between the three capitals",
      "Prague, Vienna & Budapest city tours",
      "Vltava river cruise (Prague)",
      "Schonbrunn Palace visit (Vienna)",
      "Danube cruise (Budapest); all transfers",
    ],
    exclusions: [
      "International airfare unless specified",
      "Visa fees and travel insurance",
    ...
    transparencyNote:
      "Land cost per person on twin sharing; international airfare and the Schengen visa are additional. The three capitals are linked by comfortable trains/coaches; itinerary order may flex with timetables.",
    featured: false,
    itinerary: [
      {
        day: 1,
        title: "Arrive Prague",
        description:
          "Arrive in Prague and transfer to your hotel. Evening stroll across the Charles Bridge.",
        activities: ["Airport pickup", "Charles Bridge"],
        meals: "Dinner",
        accommodation: "Hotel in Prague",
        highlight: "Charles Bridge at dusk",
      ...
      },
      {
        ...
        description:
          "The Old Town Square and astronomical clock, Prague Castle and St Vitus Cathedral, with a Vltava river cruise.",
        activities: ["Old Town Square", "Astronomical clock", "Prague Castle", "Vltava cruise"],
        meals: "Breakfast",
        accommodation: "Hotel in Prague",
        highlight: "The hilltop castle skyline",
        image: "https://images.unsplash.com/photo-1541849546-216549ae216d?w=1600&h=900&fit=crop",
      },
      {
        day: 3,
        ...
        description:
          "Train/coach to Vienna. Afternoon at the Belvedere or a Ringstrasse orientation.",
        activities: ["Travel to Vienna", "Belvedere / Ringstrasse"],
        meals: "Breakfast",
        accommodation: "Hotel in Vienna",
        highlight: "Imperial Vienna arrival",
        image: "https://images.unsplash.com/photo-1516550893923-42d28e5677af?w=1600&h=900&fit=crop",
      },
      {
        day: 4,
        ...
        meals: "Breakfast",
        accommodation: "Hotel in Vienna",
        highlight: "Schonbrunn's golden halls",
        image: "https://images.unsplash.com/photo-1516550893923-42d28e5677af?w=1600&h=900&fit=crop",
      },
      {
        day: 5,
        ...
        description:
          "Travel to Budapest. Evening Danube cruise past the illuminated Parliament and Chain Bridge.",
        activities: ["Travel to Budapest", "Danube cruise", "Parliament by night"],
        meals: "Breakfast",
      ...
      },
      {
        ...
        description:
          "Buda Castle, the Fisherman's Bastion and Matthias Church, then the Pest side and Heroes' Square.",
        activities: ["Buda Castle", "Fisherman's Bastion", "Matthias Church", "Heroes' Square"],
        meals: "Breakfast",
        accommodation: "Hotel in Budapest",
        highlight: "Fisherman's Bastion views",
        image: "https://images.unsplash.com/photo-1565426873118-a17ed65d74b9?w=1600&h=900&fit=crop",
      },
      {
        day: 7,
  ...
  },
  {
    ...
    reviewCount: 46,
    inclusions: [
      "8 nights in 4-star hotels with breakfast",
      "2 domestic flights (Sydney-Cairns-Melbourne)",
      "Sydney city tour + harbour cruise",
      "Great Barrier Reef snorkelling day",
      "Blue Mountains day trip",
      "Great Ocean Road tour; all transfers",
    ],
    exclusions: [
      "International airfare unless specified",
      "Visa fees and travel insurance",
    ...
    transparencyNote:
      "Land cost per person on twin sharing; international and the two domestic flights are additional. Great Barrier Reef trips are weather- and sea-dependent; we book reputable, certified operators. An Australian Visitor visa (subclass 600) is required.",
    featured: true,
    itinerary: [
      {
        day: 1,
        title: "Arrive Sydney",
        description:
          "Arrive in Sydney and transfer to your hotel. Evening at Darling Harbour.",
        activities: ["Airport pickup", "Darling Harbour"],
        meals: "Dinner",
        accommodation: "Hotel in Sydney",
        highlight: "First harbour lights",
        image: "https://images.unsplash.com/photo-1523482580672-f109ba8cb9be?w=1600&h=900&fit=crop",
      },
      {
        day: 2,
        title: "Sydney City & Harbour Cruise",
        description:
          "Opera House, the Royal Botanic Garden, Bondi Beach and a Sydney Harbour lunch cruise under the bridge.",
        activities: ["Opera House", "Bondi Beach", "Harbour cruise"],
        meals: "Breakfast",
        accommodation: "Hotel in Sydney",
        highlight: "Sailing past the Opera House",
      ...
      },
      {
        ...
        meals: "Breakfast",
        accommodation: "Hotel in Sydney",
        highlight: "The Three Sisters",
        image: "https://images.unsplash.com/photo-1529108190281-9a4f620bc2d8?w=1600&h=900&fit=crop",
      },
      {
        day: 4,
        title: "Sydney to Cairns",
        description:
          "Fly to tropical Cairns. Afternoon at the Esplanade lagoon and a night market.",
        activities: ["Flight to Cairns", "Cairns Esplanade", "Night market"],
        meals: "Breakfast",
        accommodation: "Hotel in Cairns",
        highlight: "Into the tropics",
        image: "https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?w=1600&h=900&fit=crop",
      },
      {
        day: 5,
        ...
        description:
          "Full-day reef cruise to an outer-reef pontoon for snorkelling over coral gardens and tropical fish.",
        activities: ["Reef cruise", "Snorkelling", "Coral gardens", "Glass-bottom boat"],
        meals: "Breakfast, Lunch",
        accommodation: "Hotel in Cairns",
        highlight: "Snorkelling the Great Barrier Reef",
        image: "https://images.unsplash.com/photo-1524293581917-878a6d017c71?w=1600&h=900&fit=crop",
      },
      {
        day: 6,
        title: "Kuranda & Daintree",
        description:
          "The Kuranda Scenic Railway and Skyrail rainforest cableway, or an optional Daintree rainforest day.",
        activities: ["Kuranda Scenic Railway", "Skyrail cableway", "Rainforest village"],
        meals: "Breakfast",
        accommodation: "Hotel in Cairns",
        highlight: "Above the rainforest canopy",
        image: "https://images.unsplash.com/photo-1494233892892-84542a694e72?w=1600&h=900&fit=crop",
      },
      {
        day: 7,
        ...
        highlight: "Melbourne's coffee laneways",
        image: "https://images.unsplash.com/photo-1514395462725-fb4566210144?w=1600&h=900&fit=crop",
      },
      {
        day: 8,
        title: "Great Ocean Road",
        description:
          "Full-day Great Ocean Road tour to the Twelve Apostles sea stacks and the Loch Ard Gorge.",
        activities: ["Great Ocean Road", "Twelve Apostles", "Loch Ard Gorge"],
        meals: "Breakfast",
        accommodation: "Hotel in Melbourne",
        highlight: "Twelve Apostles at sunset",
        image: "https://images.unsplash.com/photo-1529108190281-9a4f620bc2d8?w=1600&h=900&fit=crop",
      },
      {
        day: 9,
  ...
  },
  {
    ...
    reviewCount: 33,
    inclusions: [
      "9 nights in 3-4 star hotels with breakfast",
      "Inter-island flight (Auckland-Christchurch/Queenstown)",
      "Rotorua geothermal & Maori cultural evening",
      "Hobbiton movie-set tour",
      "Milford Sound nature cruise",
      "Queenstown gondola; all coach transfers",
    ],
    exclusions: [
      "International airfare unless specified",
      "Visa fees and travel insurance",
    ...
    itinerary: [
      {
        ...
        description:
          "Arrive in Auckland, the City of Sails. Evening at the Viaduct Harbour and Sky Tower.",
        activities: ["Airport pickup", "Viaduct Harbour", "Sky Tower"],
        meals: "Dinner",
      ...
      {
        day: 2,
        title: "Auckland to Waitomo & Rotorua",
        description:
          "Glide through the glow-worm-lit Waitomo Caves, then on to Rotorua for a Maori hangi dinner and cultural show.",
        activities: ["Waitomo glow-worm caves", "Drive to Rotorua", "Maori hangi & culture"],
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Rotorua",
        highlight: "Glow-worm cave boat ride",
        image: "https://images.unsplash.com/photo-1578645510447-e20b4311e3ce?w=1600&h=900&fit=crop",
      },
      {
        day: 3,
        title: "Rotorua & Hobbiton",
        description:
          "Te Puia geysers and mud pools, then the green Hobbiton movie set from the Lord of the Rings films.",
        activities: ["Te Puia geysers", "Mud pools", "Hobbiton movie set"],
        meals: "Breakfast",
        accommodation: "Hotel in Rotorua",
        highlight: "Walking through the Shire",
      ...
      },
      {
        ...
        highlight: "Garden City of the south",
        image: "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=1600&h=900&fit=crop",
      },
      {
        day: 5,
        title: "Christchurch to Lake Tekapo & Mount Cook",
        description:
          "Drive inland to the turquoise Lake Tekapo and the Church of the Good Shepherd, beneath Aoraki/Mount Cook.",
        activities: ["Lake Tekapo", "Church of the Good Shepherd", "Mount Cook views"],
        meals: "Breakfast",
        accommodation: "Hotel near Mount Cook",
        highlight: "Turquoise Lake Tekapo",
        image: "https://images.unsplash.com/photo-1530789253388-582c481c54b0?w=1600&h=900&fit=crop",
      },
      {
        day: 6,
        title: "Mount Cook to Queenstown",
        description:
          "Scenic drive past Lake Pukaki to Queenstown, the adventure capital. Evening Skyline gondola and luge.",
        activities: ["Lake Pukaki", "Drive to Queenstown", "Skyline gondola"],
        meals: "Breakfast",
        accommodation: "Hotel in Queenstown",
        highlight: "Queenstown from the gondola",
        image: "https://images.unsplash.com/photo-1469521669194-babb45599def?w=1600&h=900&fit=crop",
      },
      {
        day: 7,
        ...
        description:
          "Full-day excursion to Milford Sound for a nature cruise past Mitre Peak and the waterfalls of the fiord.",
        activities: ["Milford Sound cruise", "Mitre Peak", "Fiord waterfalls"],
        meals: "Breakfast, Lunch",
        accommodation: "Hotel in Queenstown",
      ...
      },
      {
        ...
        meals: "Breakfast",
        accommodation: "Hotel in Queenstown",
        highlight: "Jetboating the Shotover",
        image: "https://images.unsplash.com/photo-1578645510447-e20b4311e3ce?w=1600&h=900&fit=crop",
      },
      {
        day: 9,
        title: "Queenstown at Leisure",
        description:
          "A morning lake cruise on the TSS Earnslaw to Walter Peak, with the afternoon for shopping and cafes.",
        activities: ["TSS Earnslaw cruise", "Walter Peak", "Lakefront stroll"],
        meals: "Breakfast",
        accommodation: "Hotel in Queenstown",
        highlight: "Steamship across Wakatipu",
        image: "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=1600&h=900&fit=crop",
      },
      {
        day: 10,
  ...
  },
  {
    ...
    reviewCount: 36,
    inclusions: [
      "4 nights in a 3-4 star Almaty hotel with breakfast",
      "Big Almaty Lake half-day tour",
      "Charyn Canyon full-day excursion",
      "Shymbulak & Kok-Tobe cable cars",
      "Almaty city tour; all transfers",
    ],
    exclusions: [
      "International airfare unless specified",
      "Visa fees and travel insurance",
    ...
    itinerary: [
      {
        ...
        title: "Arrive Almaty",
        description:
          "Arrive in Almaty and transfer to your hotel. Evening at Kok-Tobe hill by cable car for city views.",
        activities: ["Airport pickup", "Kok-Tobe cable car", "City views"],
        meals: "Dinner",
        accommodation: "Hotel in Almaty",
        highlight: "Almaty from Kok-Tobe",
      ...
      },
      {
        ...
        meals: "Breakfast",
        accommodation: "Hotel in Almaty",
        highlight: "Turquoise Big Almaty Lake",
        image: "https://images.unsplash.com/photo-1605281317010-fe5ffe798166?w=1600&h=900&fit=crop",
      },
      {
        day: 3,
        title: "Charyn Canyon",
        description:
          "Full-day excursion to Charyn Canyon, hiking the red-rock Valley of Castles.",
        activities: ["Charyn Canyon", "Valley of Castles hike", "Charyn River"],
        meals: "Breakfast, Lunch",
        accommodation: "Hotel in Almaty",
        highlight: "The Valley of Castles",
        image: "https://images.unsplash.com/photo-1490650034439-fd184c3c86a5?w=1600&h=900&fit=crop",
      },
      {
        day: 4,
        ...
        description:
          "Cable car to the Shymbulak mountain resort and the high-altitude Medeu skating rink in the Tien Shan.",
        activities: ["Medeu skating rink", "Shymbulak cable car", "Tien Shan views"],
        meals: "Breakfast",
        accommodation: "Hotel in Almaty",
        highlight: "Above Almaty at Shymbulak",
        image: "https://images.unsplash.com/photo-1518684079-3c830dcef090?w=1600&h=900&fit=crop",
      },
      {
        day: 5,
  ...
  },
  {
    ...
    reviewCount: 31,
    inclusions: [
      "7 nights in 3-4 star hotels with breakfast",
      "Afrosiyob high-speed train tickets",
      "Tashkent, Samarkand, Bukhara & Khiva tours",
    ...
    itinerary: [
      {
        ...
        description:
          "Arrive in Tashkent and transfer to your hotel. Evening orientation of the modern capital.",
        activities: ["Airport pickup", "City orientation"],
        meals: "Dinner",
        accommodation: "Hotel in Tashkent",
        highlight: "Silk Road gateway",
        image: "https://images.unsplash.com/photo-1539020140153-e479b8c22e70?w=1600&h=900&fit=crop",
      },
      {
        day: 2,
        title: "Tashkent City & Train to Samarkand",
        description:
          "Tashkent's Khast Imam complex and Chorsu Bazaar, then the Afrosiyob high-speed train to Samarkand.",
        activities: ["Khast Imam", "Chorsu Bazaar", "Tashkent metro", "Train to Samarkand"],
        meals: "Breakfast",
        accommodation: "Hotel in Samarkand",
        highlight: "The bullet train to Samarkand",
      ...
      },
      {
        ...
        description:
          "The Ark fortress, the Kalyan minaret and mosque, the trading domes and the Lyabi-Hauz pool.",
        activities: ["The Ark fortress", "Kalyan Minaret", "Trading domes", "Lyabi-Hauz"],
        meals: "Breakfast",
        accommodation: "Hotel in Bukhara",
      ...
      },
      {
        ...
        description:
          "Drive across the Kyzylkum desert to Khiva, the walled caravan town. Evening within the Itchan Kala walls.",
        activities: ["Kyzylkum desert drive", "Khiva arrival", "Itchan Kala by night"],
        meals: "Breakfast",
        accommodation: "Hotel in Khiva",
        highlight: "Sunset over the Itchan Kala",
        image: "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=1600&h=900&fit=crop",
      },
      {
        day: 7,
        title: "Khiva & Fly to Tashkent",
        description:
          "Tour the open-air museum of Itchan Kala, then fly from Urgench back to Tashkent.",
        activities: ["Itchan Kala museum-city", "Kalta Minor minaret", "Flight to Tashkent"],
        meals: "Breakfast",
        accommodation: "Hotel in Tashkent",
        highlight: "The walled town of Khiva",
        image: "https://images.unsplash.com/photo-1539020140153-e479b8c22e70?w=1600&h=900&fit=crop",
      },
      {
        day: 8,
  ...
  },
  {
    ...
    exclusions: [
      "Train/flight fare to and from the start city",
      "Personal expenses and shopping",
      "Any monument/activity not listed in the inclusions",
      "Travel insurance (can be arranged on request)",
      "Anything not mentioned under inclusions",
    ],
    highlights: [
      "Jim Corbett jeep safari",
      "Tiger reserve & ecosystems",
      "Nature interpretation centre",
      "Kosi river ecology walk",
      "Conservation & biodiversity learning",
    ],
    transparencyNote:
    ...
    itinerary: [
      {
        ...
        meals: "Lunch, Dinner",
        accommodation: "Student resort near Corbett",
        highlight: "First evening in tiger country",
        image: "https://images.unsplash.com/photo-1549366021-9f761d450615?w=1600&h=900&fit=crop",
      },
      {
        day: 2,
        title: "Dawn Jeep Safari & River Ecology",
        description:
          "An early jeep safari into the Bijrani/Jhirna zone in search of tigers, elephants and deer. Afternoon at the nature-interpretation centre and a guided walk along the Kosi river to study riverine ecology.",
        activities: ["Dawn jeep safari", "Wildlife spotting", "Interpretation centre", "Kosi river ecology walk"],
        meals: "Breakfast, Lunch, Dinner",
        accommodation: "Student resort near Corbett",
        highlight: "The dawn jungle safari",
    ...
    itinerary: [
      {
        ...
        meals: "Lunch, Dinner",
        accommodation: "Student hotel in Delhi",
        highlight: "Standing inside the Red Fort",
        image: "https://images.unsplash.com/photo-1587474260584-136574528ed5?w=1600&h=900&fit=crop",
      },
      {
        day: 2,
        ...
        meals: "Breakfast, Lunch, Dinner",
        accommodation: "Student hotel in Delhi",
        highlight: "A hands-on science afternoon",
        image: "https://images.unsplash.com/photo-1548013146-72479768bada?w=1600&h=900&fit=crop",
      },
      {
        day: 3,
        ...
        meals: "Breakfast, Lunch, Dinner",
        accommodation: "Student hotel in Agra",
        highlight: "The Taj Mahal up close",
        image: "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=1600&h=900&fit=crop",
      },
      {
        day: 4,
    ...
    itinerary: [
      {
        ...
        meals: "Lunch, Dinner",
        accommodation: "Student hotel in Jaipur",
        highlight: "Reading the giant sundials",
        image: "https://images.unsplash.com/photo-1599661046289-e31897846e41?w=1600&h=900&fit=crop",
      },
      {
        day: 2,
        title: "Amber Fort, Jaigarh & Albert Hall",
        description:
          "Morning at the hilltop Amber Fort and the Jaigarh Fort with the world's largest cannon-on-wheels; afternoon at the Albert Hall Museum and the local bazaars for handicrafts.",
        activities: ["Amber Fort", "Jaigarh Fort", "Albert Hall Museum", "Bazaar walk"],
        meals: "Breakfast, Lunch, Dinner",
        accommodation: "Student hotel in Jaipur",
        highlight: "The ramparts of Amber Fort",
    ...
    itinerary: [
      {
        ...
        description:
          "Board the bus to Shimla, the former summer capital of British India. Evening walk on the Ridge and Mall Road with a history briefing.",
        activities: ["Drive to Shimla", "The Ridge", "Mall Road", "History briefing"],
        meals: "Lunch, Dinner",
        accommodation: "Student hotel in Shimla",
        highlight: "First evening on the Ridge",
      ...
      },
      {
        ...
        description:
          "Scenic drive to Manali along the Beas river through the Kullu valley, with stops to understand river and valley geography.",
        activities: ["Kullu valley drive", "Beas river", "River geography stop", "Manali check-in"],
        meals: "Breakfast, Lunch, Dinner",
      ...
      },
      {
        ...
        meals: "Breakfast, Lunch, Dinner",
        accommodation: "Student hotel in Manali",
        highlight: "Adventure day at Solang",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Pangot birding forest",
      "Snow View cable car",
      "Freshwater & forest ecosystems",
    ],
    transparencyNote:
      "Designed for school and college groups (20-150 students). Price is per student on group sharing; accompanying teachers/escorts travel complimentary as per group size. Includes a TravelSense tour educator, a learning workbook, first-aid and 24x7 supervision. Dates, board (veg/Jain meals) and the academic focus are customised to your institution.",
    experienceStory:
    ...
    itinerary: [
      {
        day: 1,
        title: "Delhi/NCR to Nainital",
        description:
          "Drive up to Nainital, the gem of the Kumaon. Evening boat on the emerald Naini Lake and an orientation on the region's lake systems.",
        activities: ["Drive to Nainital", "Naini Lake boat", "Lake-system orientation"],
        meals: "Lunch, Dinner",
        accommodation: "Student hotel in Nainital",
        highlight: "First boat on Naini Lake",
      ...
      },
      {
        ...
        meals: "Breakfast, Lunch, Dinner",
        accommodation: "Student hotel in Nainital",
        highlight: "Seven lakes at Sattal",
        image: "https://images.unsplash.com/photo-1472396961693-142e6e269027?w=1600&h=900&fit=crop",
      },
      {
        day: 3,
        title: "Snow View & Pangot Birding",
        description:
          "Cable car to Snow View for Himalayan peaks, then a morning in the birding forests of Pangot with a naturalist to spot Himalayan species.",
        activities: ["Snow View cable car", "Pangot birding walk", "Naturalist session"],
        meals: "Breakfast, Lunch, Dinner",
        accommodation: "Student hotel in Nainital",
  ...
  },
  {
    ...
    highlights: [
      "Har ki Pauri Ganga Aarti",
      "Rishikesh suspension bridges",
      "White-water rafting (graded)",
      "River ecology session",
      "Yoga introduction",
    ],
    transparencyNote:
      "Designed for school and college groups (20-150 students). Price is per student on group sharing; accompanying teachers/escorts travel complimentary as per group size. Includes a TravelSense tour educator, a learning workbook, first-aid and 24x7 supervision. Dates, board (veg/Jain meals) and the academic focus are customised to your institution.",
    ...
    itinerary: [
      ...
      },
      {
        ...
        meals: "Breakfast, Lunch, Dinner",
        accommodation: "Student hotel in Rishikesh",
        highlight: "Rafting the Ganga rapids",
        image: "https://images.unsplash.com/photo-1561361513-2d000a50f0dc?w=1600&h=900&fit=crop",
      },
      {
        day: 3,
  ...
  },
  {
    ...
    highlights: [
      ...
      "Darjeeling tea estate & processing",
      "Darjeeling Himalayan Railway (toy train)",
      "Gangtok Rumtek & Zoological Park",
      "Himalayan geography & tea science",
    ],
    transparencyNote:
      "Designed for school and college groups (20-150 students). Price is per student on group sharing; accompanying teachers/escorts travel complimentary as per group size. Includes a TravelSense tour educator, a learning workbook, first-aid and 24x7 supervision. Dates, board (veg/Jain meals) and the academic focus are customised to your institution.",
    experienceStory:
    ...
    itinerary: [
      {
        ...
        title: "Bagdogra to Gangtok",
        description:
          "Arrive at Bagdogra and drive up to Gangtok, the Sikkim capital. Evening orientation and a walk on M.G. Marg.",
        activities: ["Drive to Gangtok", "M.G. Marg", "Orientation"],
        meals: "Lunch, Dinner",
        accommodation: "Student hotel in Gangtok",
        highlight: "Into the Eastern Himalaya",
      ...
      },
      {
        ...
        meals: "Breakfast, Lunch, Dinner",
        accommodation: "Student hotel in Gangtok",
        highlight: "Red pandas at the zoo park",
        image: "https://images.unsplash.com/photo-1622308644420-b20142dc993c?w=1600&h=900&fit=crop",
      },
      {
        day: 3,
        title: "Gangtok to Darjeeling",
        description:
          "Scenic drive to Darjeeling, the tea capital. Evening at the Chowrasta Mall with a briefing on the region's tea history.",
        activities: ["Drive to Darjeeling", "Chowrasta Mall", "Tea-history briefing"],
        meals: "Breakfast, Lunch, Dinner",
      ...
      {
        day: 4,
        title: "Tiger Hill Sunrise, Tea Estate & Toy Train",
        description:
          "Pre-dawn trip to Tiger Hill for sunrise over Kanchenjunga, then a working tea estate to study tea processing, the Himalayan Mountaineering Institute, and a ride on the UNESCO Darjeeling Himalayan Railway.",
        activities: ["Tiger Hill sunrise", "Tea estate & processing", "HMI & Padmaja Zoo", "Toy-train joy ride"],
        meals: "Breakfast, Lunch, Dinner",
        accommodation: "Student hotel in Darjeeling",
        highlight: "Sunrise on Kanchenjunga",
        image: "https://images.unsplash.com/photo-1571536802807-30451a456b58?w=1600&h=900&fit=crop",
    ...
    itinerary: [
      {
        ...
        highlight: "First sunset on the Arabian Sea",
      ...
      },
      {
        ...
        meals: "Breakfast, Lunch, Dinner",
        accommodation: "Student hotel in Goa",
        highlight: "Inside the Basilica of Bom Jesus",
        image: "https://images.unsplash.com/photo-1587922546307-776227941871?w=1600&h=900&fit=crop",
      },
      {
        day: 3,
        title: "Forts, Beaches & Marine Ecology",
        description:
          "Visit Aguada Fort and a lighthouse, then a guided session on beach and intertidal ecology, ending with supervised time at a calm beach.",
        activities: ["Aguada Fort", "Lighthouse", "Marine ecology session", "Supervised beach time"],
        meals: "Breakfast, Lunch, Dinner",
        accommodation: "Student hotel in Goa",
