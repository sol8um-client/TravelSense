...
export const packages: Package[] = [
  ...
  {
    title: "Gangtok & Darjeeling — Sikkim Capital & the Queen of Hills",
    slug: "sikkim-darjeeling-gangtok",
    destinationName: "Sikkim & Darjeeling",
    destinationSlug: "sikkim-darjeeling",
    category: "leisure",
    description:
      "A six-day Eastern Himalayan circuit pairing Gangtok — the capital of Sikkim — with Darjeeling, the Queen of Hills in West Bengal. Three nights in Gangtok for its monasteries and the sacred Tsomgo Lake and Baba Mandir, and two nights in Darjeeling for the Tiger Hill sunrise, toy train and tea gardens.",
    ...
    highlights: [
      ...
      "Darjeeling toy train & Batasia Loop",
      "Himalayan Mountaineering Institute",
    ],
    itinerary: [
      {
        day: 1,
        title: "Arrival at Bagdogra — Drive to Gangtok",
        description:
          "Arrive at Bagdogra airport / NJP railway station and drive up the Teesta valley to Gangtok, the capital of Sikkim. Photo stops along the river en route. Check in and rest, with an easy evening on MG Marg.",
        activities: ["Pickup at Bagdogra", "Drive to Gangtok", "Teesta valley photo stops", "MG Marg evening"],
        meals: "Dinner",
        accommodation: "Hotel in Gangtok",
        elevation: "1,650 m at Gangtok",
      ...
      },
      {
        ...
        description:
          "A full day around Gangtok — Tashi Viewpoint for Himalayan views, Ganesh Tok and Hanuman Tok hilltop temples, the Do-Drul Chorten stupa, the Cottage & Handloom Centre, and the Ban Jhakri and Bakthang waterfalls.",
        activities: ["Tashi Viewpoint", "Ganesh Tok & Hanuman Tok", "Do-Drul Chorten", "Handloom Centre", "Bakthang Falls"],
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Gangtok",
        highlight: "Himalayan views from Tashi Viewpoint",
      ...
      },
      {
        ...
        description:
          "Full-day excursion to the sacred Tsomgo (Changu) Lake at 12,310 ft — a glacial lake that changes colour with the seasons — and the Baba Harbhajan Singh Mandir near the China border. Optional extension to Nathula Pass (at extra cost, subject to permits).",
      ...
      {
        day: 4,
        title: "Drive Gangtok to Darjeeling",
        description:
          "Drive across to Darjeeling — the Queen of Hills — through the Teesta valley and tea-garden country. After check-in, walk the Mall and Chowrasta, and browse the market for souvenirs.",
        activities: ["Drive to Darjeeling", "Mall Road & Chowrasta", "Market walk"],
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Darjeeling",
        elevation: "2,050 m at Darjeeling",
        distance: "100 km drive",
        highlight: "Arrival in the Queen of Hills",
        image: "https://images.unsplash.com/photo-1558431382-27e303142255?w=600&h=400&fit=crop",
      },
      {
        day: 5,
        title: "Darjeeling — Tiger Hill Sunrise & Sightseeing",
        description:
          "Pre-dawn drive to Tiger Hill for the famous sunrise over Kanchenjunga. On the way back, stop at Batasia Loop and Ghoom Monastery. After breakfast, visit the Himalayan Mountaineering Institute, the Padmaja Naidu Zoological Park, and a working tea garden.",
        activities: ["Tiger Hill sunrise", "Batasia Loop", "Ghoom Monastery", "HMI", "Padmaja Naidu Zoo", "Tea garden visit"],
        meals: "Breakfast, Dinner",
        accommodation: "Hotel in Darjeeling",
        elevation: "2,590 m at Tiger Hill",
        highlight: "Sunrise over Kanchenjunga",
        image: "https://images.unsplash.com/photo-1574722772515-1cf04a3a6464?w=600&h=400&fit=crop",
      },
      {
        day: 6,
        ...
        description:
          "After breakfast, drive down to Bagdogra airport / NJP railway station for your onward journey home.",
        activities: ["Drive to Bagdogra", "Departure transfer"],
        meals: "Breakfast",
        accommodation: "N/A — Departure",
        distance: "95 km drive",
        highlight: "Last view of the Eastern Himalayas",
        image: "https://images.unsplash.com/photo-1558431382-27e303142255?w=600&h=400&fit=crop",
      },
    ],
  },
  ...
  {
    title: "Hyderabad Heritage & Srisailam — 4-Day Pilgrim Break",
    slug: "hyderabad-srisailam-heritage",
    destinationName: "Telangana",
    destinationSlug: "telangana",
    category: "educational",
    description:
      "A compact four-day Telangana break — Hyderabad's Charminar and Old City, Golconda Fort and the Salar Jung Museum, with a pilgrim day-trip through the Nallamala forest to the Mallikarjuna Jyotirlinga at Srisailam.",
    heroImage: "https://images.unsplash.com/photo-1672997317502-9dc18f4d8a6f?w=1600&h=900&fit=crop",
    images: [
      "https://images.unsplash.com/photo-1672997317502-9dc18f4d8a6f?w=800&h=600&fit=crop",
      "https://images.unsplash.com/photo-1583309219338-a582f1f9ca6b?w=800&h=600&fit=crop",
    ...
    inclusions: [
      ...
      "3 nights accommodation on twin-sharing with daily breakfast",
    ...
    highlights: [
      "Charminar & Hyderabad Old City",
      "Mecca Masjid & Chowmahalla Palace",
      "Srisailam Mallikarjuna Jyotirlinga",
      "Golconda Fort",
      "Salar Jung Museum",
    ...
    itinerary: [
      {
        day: 1,
        title: "Hyderabad Arrival — Old City Charms",
        description:
          "Arrive at Rajiv Gandhi International Airport and transfer to your hotel. Afternoon walk through the Old City — the Charminar, Mecca Masjid and the Nizam-era Chowmahalla Palace.",
        activities: ["Airport pickup", "Charminar", "Mecca Masjid", "Chowmahalla Palace"],
        meals: "Breakfast",
        accommodation: "Hotel in Hyderabad",
        image: "https://images.unsplash.com/photo-1672997317502-9dc18f4d8a6f?w=600&h=400&fit=crop",
      },
      {
        day: 2,
        title: "Srisailam Pilgrimage Day Trip",
        description:
          "A long day-trip south through the Nallamala forest to Srisailam for darshan at the Mallikarjuna Jyotirlinga — one of the 12 holiest Shiva shrines. Return to Hyderabad by late evening.",
        activities: ["Drive through Nallamala forest", "Mallikarjuna Jyotirlinga", "Bhramaramba Shakti Peetha"],
        meals: "Breakfast",
        accommodation: "Hotel in Hyderabad",
        image: "https://images.unsplash.com/photo-1545158539-4e6d35bb84a9?w=600&h=400&fit=crop",
      },
      {
        day: 3,
        title: "Hyderabad — Golconda Fort & Salar Jung Museum",
        description:
          "Morning at Golconda Fort with its famous acoustics, and afternoon at the Salar Jung Museum — one of the world's largest one-man art collections.",
        activities: ["Golconda Fort", "Salar Jung Museum", "Laad Bazaar"],
        meals: "Breakfast",
        accommodation: "Hotel in Hyderabad",
        image: "https://images.unsplash.com/photo-1583309219338-a582f1f9ca6b?w=600&h=400&fit=crop",
      },
      {
        ...
        title: "Hyderabad Departure",
        description:
          "After breakfast, transfer to Rajiv Gandhi International Airport for your onward journey home.",
        activities: ["Free morning", "Departure transfer"],
        meals: "Breakfast",
        accommodation: "N/A — Departure",
        image: "https://images.unsplash.com/photo-1672997317502-9dc18f4d8a6f?w=600&h=400&fit=crop",
