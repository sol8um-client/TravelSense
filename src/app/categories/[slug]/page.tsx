    ...
    leisure: [
      {
        ...
        description: "5 days of sun, sand, and serenity on the beaches of South Goa with premium beachfront stay.",
        category: "leisure",
      ...
      },
      {
        ...
        description: "Cruise through the serene backwaters of Alleppey and Kumarakom in a traditional houseboat.",
        category: "leisure",
      ...
      },
      {
        ...
        description: "Luxury overwater villa experience in the Maldives with all-inclusive dining and water sports.",
        category: "leisure",
        duration: "6 Days / 5 Nights",
        price: 95000,
        discountedPrice: 82000,
        heroImage: "https://images.unsplash.com/photo-1514282401047-d79a71a590e8?w=600&h=400&fit=crop",
        destination: { name: "Maldives", slug: "maldives", region: "South Asia" },
      },
    ],
    adventure: [
      {
        ...
        description: "Ride through the highest motorable passes in the world on this epic motorcycle adventure.",
        category: "adventure",
      ...
      },
      {
        ...
        description: "White-water rafting, bungee jumping, and camping by the Ganges in the adventure capital of India.",
        category: "adventure",
        duration: "3 Days / 2 Nights",
        price: 12000,
        heroImage: "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=600&h=400&fit=crop",
    ...
    educational: [
      {
        ...
        description: "Explore the iconic Delhi-Agra-Jaipur circuit with expert historians and guided museum visits.",
        ...
        featured: true,
        destination: { name: "Jaipur", slug: "jaipur", region: "North India" },
      },
      {
        _id: "ep2",
        title: "Varanasi Cultural Immersion",
        slug: "varanasi-cultural-immersion",
        description: "Experience the spiritual heart of India with temple visits, Ganga aarti, and classical music sessions.",
        category: "educational",
        duration: "4 Days / 3 Nights",
        price: 18000,
        heroImage: "https://images.unsplash.com/photo-1561361513-2d000a50f0dc?w=600&h=400&fit=crop",
        destination: { name: "Varanasi", slug: "varanasi", region: "North India" },
      },
    ],
    sports: [
      {
        ...
        description: "Premium IPL match tickets with luxury hotel stay and behind-the-scenes stadium access.",
        category: "sports",
        duration: "3 Days / 2 Nights",
        price: 45000,
        discountedPrice: 38000,
        heroImage: "https://images.unsplash.com/photo-1531415074968-036ba1b575da?w=600&h=400&fit=crop",
        featured: true,
        destination: { name: "Mumbai", slug: "mumbai", region: "West India" },
      },
      {
        _id: "sp2",
        title: "Dubai Marathon Package",
        slug: "dubai-marathon-package",
        description: "Run the Dubai Marathon with race registration, training support, hotel, and city sightseeing.",
        category: "sports",
        duration: "5 Days / 4 Nights",
        price: 65000,
        heroImage: "https://images.unsplash.com/photo-1452626038306-9aae5e071dd3?w=600&h=400&fit=crop",
        destination: { name: "Dubai", slug: "dubai", region: "Middle East" },
      },
    ],
  }
