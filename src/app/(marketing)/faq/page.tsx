...
const faqs = [
  // General
  {
    ...
    answer:
      "TravelSense is a curated travel platform based in Sangamner, Maharashtra. We specialize in crafting personalized leisure and adventure travel experiences for individuals, families, and corporate groups across India and internationally.",
    category: "General",
  },
  {
